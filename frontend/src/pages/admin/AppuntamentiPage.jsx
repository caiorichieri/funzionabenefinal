  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#1C1C1C] font-[Outfit]">Appuntamenti</h1>
          <p className="text-[rgba(28,28,28,0.6)] mt-1">{appuntamenti.length} sessioni totali</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-[rgba(28,28,28,0.5)]">Nessun appuntamento trovato</div>
      ) : (
        <div className="space-y-3">
          {appuntamenti.map(a => (
            <div key={a._id} data-testid={`appuntamento-${a._id}`}
              className="bg-white border border-[rgba(28,28,28,0.08)] rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#D4A017]/10 flex flex-col items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-1 text-sm text-[rgba(28,28,28,0.5)]">
                  ...
                  {a.note && <div className="text-xs text-[rgba(28,28,28,0.5)] mt-1">{a.note}</div>}
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
            <div className="flex items-center justify-between p-6 border-b border-[rgba(28,28,28,0.08)]">
              <h2 className="text-xl font-bold text-[#1C1C1C] font-[Outfit]">Nuovo Appuntamento</h2>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[#1C1C1C] mb-1">Terapeuta*</label>
              ...
              <div>
                <label className="block text-sm font-medium text-[#1C1C1C] mb-1">Paziente*</label>
              ...
              <div>
                <label className="block text-sm font-medium text-[#1C1C1C] mb-1">Data e Ora*</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#1C1C1C] mb-1">Durata (min)</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-[#1C1C1C] mb-1">Tipo</label>
              ...
              <div>
                <label className="block text-sm font-medium text-[#1C1C1C] mb-1">Note</label>

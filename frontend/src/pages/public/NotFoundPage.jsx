...
export default function NotFoundPage() {
  return (
    <main className="min-h-[calc(100vh-80px)] bg-[#111111] flex items-center justify-center px-6 py-20" data-testid="404-page">
      <div className="text-center max-w-lg">
        <Mascotte name="curioso" theme="dark" size={180} animation="wiggle" />
        ...
        <p className="mt-6 text-[#E6E2D8]/60 leading-relaxed">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            ...
            className="px-6 py-3 text-[#E6E2D8]/70 hover:text-[#D4A017] text-sm tracking-wide"
          >

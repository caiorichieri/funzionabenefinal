  ...
  return (
    <main className="min-h-[calc(100vh-80px)] bg-[#E5D9C5] py-16 lg:py-24" data-testid="blog-post">
      <article className="max-w-3xl mx-auto px-6 lg:px-10">
        ...
        <div className="mt-8 pb-8 border-b border-[rgba(28,28,28,0.08)] flex flex-wrap gap-6 text-sm text-[rgba(28,28,28,0.5)]">
        ...
        {articolo.immagine_url && (
          <div className="mt-10 rounded-3xl overflow-hidden border border-[rgba(28,28,28,0.05)]">
            <img
        ...
        {isHtml ? (
          ...
          <div className="mt-10">
            {contenuto.split("\n").filter(Boolean).map((p, i) => (
              <p key={i} className="text-lg text-[rgba(28,28,28,0.7)] leading-loose mb-6 font-serif">
                {p}
              </p>
            ))}
          </div>
        ...
        <div className="mt-16 p-8 bg-white/40 border border-[rgba(28,28,28,0.08)] rounded-3xl text-center">
          <h3 className="font-serif text-2xl text-[#1C1C1C] mb-3">Hai bisogno di parlarne?</h3>
          <p className="text-[rgba(28,28,28,0.6)] mb-6">Prova il nostro questionario e trova lo specialista giusto per te.</p>
          <Link
            to="/questionario"

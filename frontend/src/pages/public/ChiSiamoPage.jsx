    ...
    <main className="min-h-[calc(100vh-80px)] bg-[#111111]" data-testid="chi-siamo-page">
      ...
      <section className="max-w-5xl mx-auto px-6 lg:px-10 py-20 lg:py-28" data-testid="mission-section">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 text-[#E6E2D8]/75 leading-relaxed text-lg">
            <p>
              La sessualità è ancora, nel 2026, uno dei temi più <strong className="text-[#F4F1ED]">non detti</strong> della
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10 grid md:grid-cols-4 gap-8">
          {STATS.map((s, i) => (
            ...
            >
              ...
              <div className="mt-3 text-xs tracking-[0.2em] uppercase text-[#E6E2D8]/55">{s.desc}</div>
            </motion.div>
          ))}
        </div>
      </section>
          ...
          {VALUES.map((v, i) => {
            ...
            return (
              <motion.div
                ...
                data-testid={`value-${i}`}
                className="p-7 bg-[#1C2A33]/30 border border-white/10 rounded-3xl"
              >
                <div className="w-12 h-12 rounded-2xl bg-[#D4A017]/10 flex items-center justify-center mb-5">
                  <Icon className="w-5 h-5 text-[#D4A017]" />
                </div>
                <h3 className="font-serif text-xl text-[#F4F1ED] mb-3 leading-tight">{v.titolo}</h3>
                <p className="text-sm text-[#E6E2D8]/65 leading-relaxed" dangerouslySetInnerHTML={{ __html: v.desc }} />
              </motion.div>
            );
          })}
        </div>
      ...
      <section className="bg-[#0A0A0A] border-y border-white/5" data-testid="team-section">
        <div className="max-w-5xl mx-auto px-6 lg:px-10 py-20 lg:py-28">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-[#E6E2D8]/75 leading-relaxed">
              <p>
              ...
              <p>
                Verifichiamo <strong className="text-[#F4F1ED]">ogni trimestre</strong> l'iscrizione all'Albo, la validità
      ...
      <section className="max-w-4xl mx-auto px-6 lg:px-10 py-20 lg:py-28" data-testid="why-section">
        ...
        <h2 className="mt-4 font-serif text-4xl lg:text-5xl text-[#F4F1ED] leading-tight mb-10">
          Uno può fare tutto.<br />Oppure fare una cosa sola, benissimo.
        </h2>
        <div className="space-y-6 text-[#E6E2D8]/75 leading-relaxed text-lg">
          <p>
            ...
            che serva <strong className="text-[#F4F1ED]">chi ha fatto di questa materia la sua vita professionale</strong>.
          </p>
          <p>
      ...
      <section className="max-w-5xl mx-auto px-6 lg:px-10 pb-20">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#D4A017]/10 via-[#1C2A33]/60 to-[#111111] border border-[#D4A017]/30 p-10 lg:p-16 text-center">
          <h2 className="font-serif text-4xl lg:text-5xl text-[#F4F1ED] leading-tight max-w-2xl mx-auto">
            Ora che ci conosci, parliamo di te.
          </h2>
          <p className="mt-5 text-[#E6E2D8]/65 max-w-xl mx-auto">

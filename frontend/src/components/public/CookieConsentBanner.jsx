          ...
          <div className="max-w-5xl mx-auto bg-[#111111]/98 backdrop-blur-xl border border-[#0A0A0A]/20 rounded-3xl shadow-2xl shadow-black/50 p-6 lg:p-8">
            {!customize ? (
              <div className="grid lg:grid-cols-[auto_1fr_auto] gap-6 items-center">
                ...
                <div>
                  <h3 className="font-serif text-xl text-[#0A0A0A] mb-1">La tua privacy conta.</h3>
                  <p className="text-sm text-[#0A0A0A]/70 leading-relaxed">
                    ...
                    Per saperne di più consulta la <Link to="/cookie" className="text-[#0A0A0A] hover:text-[#0A0A0A]/70 underline">Cookie Policy</Link>.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row gap-3 lg:flex-col xl:flex-row">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-5 py-3 text-sm text-[#0A0A0A]/85 hover:text-[#0A0A0A] border border-[#0A0A0A]/15 hover:bg-white/5 rounded-full tracking-wide transition-all"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-3 text-sm text-[#0A0A0A] border border-[#0A0A0A]/20 hover:bg-white/5 rounded-full tracking-wide transition-all"
                  >
                    Solo essenziali
                  </button>
                  <button
                    ...
                    className="px-5 py-3 text-sm bg-[#0A0A0A] hover:bg-[#1C1C1C] text-white font-medium rounded-md tracking-wide transition-all"
                  >
                    Accetta tutti
                  </button>
                </div>
              ...
              <div data-testid="banner-customize-panel">
                <div className="flex items-start justify-between mb-5">
                  <div>
                    <h3 className="font-serif text-xl text-[#0A0A0A] mb-1">Le tue preferenze</h3>
                    <p className="text-xs text-[#0A0A0A]/60">Attiva solo quello che preferisci — potrai modificare in qualsiasi momento.</p>
                  </div>
                  <button onClick={() => setCustomize(false)} className="p-1 text-[#0A0A0A]/60 hover:text-[#0A0A0A]">
                    <X className="w-4 h-4" />
                  </button>
                </div>

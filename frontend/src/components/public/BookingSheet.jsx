            ...
            {step === "review" && (
              <div data-testid="step-review">
                ...
                <button
                  ...
                  className="mt-8 w-full inline-flex items-center justify-center gap-3 px-6 py-4 bg-[#0A0A0A] hover:bg-[#1C1C1C] text-white font-medium rounded-md transition-all"
                >
              ...
              <div data-testid="step-auth">
                ...
                <form onSubmit={mode === "register" ? handleRegister : handleLogin} className="mt-8 space-y-4">
                  ...
                  <button
                    ...
                    className="w-full mt-4 inline-flex items-center justify-center gap-3 px-6 py-4 bg-[#0A0A0A] hover:bg-[#1C1C1C] disabled:opacity-40 text-white font-medium rounded-md transition-all"
                  >
              ...
              <div data-testid="step-otp">
                ...
                <form onSubmit={handleOTP} className="mt-8">
                  ...
                  <button
                    ...
                    className="w-full mt-6 inline-flex items-center justify-center gap-3 px-6 py-4 bg-[#0A0A0A] hover:bg-[#1C1C1C] disabled:opacity-40 text-white font-medium rounded-md"
                  >
              ...
              <div data-testid="step-payment">
                ...
                <form onSubmit={handlePayment} className="mt-8 space-y-4">
                  ...
                  <button
                    ...
                    type="submit" disabled={loading}
                    className="w-full inline-flex items-center justify-center gap-3 px-6 py-4 bg-[#0A0A0A] hover:bg-[#1C1C1C] disabled:opacity-40 text-white font-medium rounded-md"
                  >

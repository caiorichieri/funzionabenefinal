    ...
    <div data-testid="step-dati-fiscali">
      ...
      <form onSubmit={submit} className="mt-6 space-y-5">
        ...
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-3 px-6 py-4 disabled:opacity-40 bg-gradient-to-r from-[#F58A1F] to-[#F5D419] hover:from-[#E07A0F] hover:to-[#E5C419] text-[#0A0A0A] font-bold rounded-2xl shadow-md hover:shadow-lg transition-all"
        >

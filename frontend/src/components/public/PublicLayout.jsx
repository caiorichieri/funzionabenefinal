          ...
          {user && user.role ? (
            ...
            <>
              ...
              <Link
                to="/questionario"
                data-testid="nav-cta"
                className="px-5 py-2.5 bg-[#0A0A0A] hover:bg-[#1C1C1C] text-white font-medium rounded-md text-sm tracking-wide transition-all"
              >
              ...
              {user && user.role ? (
                ...
                <>
                  ...
                  <Link
                    to="/questionario"
                    onClick={() => setOpen(false)}
                    className="inline-block w-full text-center px-5 py-3 bg-[#0A0A0A] text-white font-medium rounded-md"
                  >
                    Inizia il Questionario
                  </Link>
                </>
